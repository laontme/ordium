                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route("orders.insert", $absolute = false)}}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <textarea name="description" id="description" cols="30" rows="5" class="form-control @error('description') is-invalid @enderror" required>{{ old('description') }}</textarea>
